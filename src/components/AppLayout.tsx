...
import MenuIcon from '@mui/icons-material/Menu'; // ✅ 1. Importamos el ícono de menú
...
function AppLayout() {
    ...
    const menuItems = [
        ...
        { text: 'Rubros', icon: <CategoryIcon />, path: '/rubros' },
        { text: 'Historial de Ventas', icon: <PointOfSaleIcon />, path: '/ventas' },
    ];
