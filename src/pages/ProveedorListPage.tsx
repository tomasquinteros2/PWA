...
import {
    ...
    Tooltip // ✅ 1. Importamos Tooltip para dar feedback al usuario
} from '@mui/material';
    ...
    const handleGeneratePdf = async (proveedor: Proveedor) => {
        ...
        try {
            ...
            autoTable(doc, {
                ...
                headStyles: { fillColor: [76, 175, 80] }, // Verde del tema
                styles: { fontSize: 9 },
            });
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center">Lista de Precios</TableCell> {/* ✅ 8. Nueva columna */}
